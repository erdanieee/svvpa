				...
				<div class="container">
					...
					function endsWith($haystack, $needle) {
						...
						foreach (new DirectoryIterator($path) as $fileInfo) {
								if(!$fileInfo->isDot() && endsWith($fileInfo->getFilename(),'.mp4')){
									$file =  $fileInfo->getBasename('.mp4');
						...
						foreach($filesByName as $f){
								...
								if(file_exists ("motion/".$name.".jpg")){
									echo "<video width=\"100%\" controls poster=\"$path/$name.jpg\" preload=\"none\">";
								}else{
								...
								echo "<li><a href=\"download.php/?n=$name.mp4\" class=\"button icon fa-download\">Descargar</a></li>";
